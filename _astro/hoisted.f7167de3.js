...
`,C={en:{tooltip:{idle:"Copy to clipboard",success:"Copied!",failed:"Failed to copy"}},es:{tooltip:{idle:"Copiar al portapapeles",success:"¡Copiado!",failed:"Error al copiar"}}};function x(){const h=document.documentElement.lang,i=C[h],m=document.querySelectorAll("pre"),s=document.createElement("style");s.type="text/css",s.textContent=w,document.head.appendChild(s);const l=`
