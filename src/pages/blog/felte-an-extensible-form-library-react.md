...
This validator package exports a function called `validator` which can be passed as-is to the `extend` option of `useForm`. Your validation schema can then be passed to the `validateSchema` option:
